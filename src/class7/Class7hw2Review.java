...
public class Class7hw2Review {

	public static void main(String[] args) {
	
		/*2. Ask user what he/she wants to buy, ask for price and to pay for an item.
		...
		System.out.println("Please enter the item you purchase");
		item=input.next();
		...
		System.out.println("Please pay for the item "+ item);
